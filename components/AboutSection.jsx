          ...
          {milestones.map((milestone, index) => (
            ...
            >
              ...
              <div className="w-full md:w-1/2 px-8">
                <div
                  className={`p-6 rounded-2xl bg-surface border border-bg-accent hover:border-amber-glow transition-all duration-300 glow-card ${
              ...
              {/* Center Dot */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 rounded-full bg-amber glow-amber border-4 border-surface z-10" />
            </div>
          ))}
        </div>
      </div>
