...
export default function Footer() {
  return (
    <footer className="bg-linear-to-b from-bg-secondary to-bg-accent border-t border-bg-accent pt-16 pb-8 px-4">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="p-3 bg-surface border border-bg-accent rounded-lg hover:border-amber/50 transition-all group shadow-sm hover:shadow-md"
                  aria-label={social.label}
                >
                  <span className="text-text-muted group-hover:text-amber transition-colors">
                    {social.icon}
                  </span>
                </a>
              ))}
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-bg-accent flex flex-col md:flex-row items-center justify-between gap-4">
